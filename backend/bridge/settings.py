...
INSTALLED_APPS = [
    ...
    # third party apps
    'corsheaders',
    'channels',  # webSocket - notification connection
    'rest_framework',
...
# Настройка CORS_ALLOW_ALL_ORIGINS
CORS_ALLOW_ALL_ORIGINS = config('DJANGO_CORS_ALLOW_ALL_ORIGINS', default='False') == 'True'
